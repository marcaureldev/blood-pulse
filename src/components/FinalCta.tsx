...
export function FinalCta() {
  ...
  return (
    <section className="relative overflow-hidden bg-blood-600 py-[clamp(4rem,10vw,4rem)] text-center text-white">
      <span
        aria-hidden="true"
      ...
      <div
        className="relative z-1 mx-auto max-w-4xl px-5 sm:px-8"
      >
